...
import { load, save, findById, add, update, remove, validate } from './business.js'
...
function renderStudents() {
    ...
    students.forEach((student) => {
      ...
      <td>
        <div class="actions">
            <button class="action-button" data-action="details" data-id="${student.id}" aria-label="Подробнее о студенте ${escapeHtml(student.fullName)}">Подробнее</button>
            <button class="action-button" data-action="edit" data-id="${student.id}" aria-label="Изменить данные студента ${escapeHtml(student.fullName)}">Изменить</button>
            <button class="action-button delete-button" data-action="delete" data-id="${student.id}" aria-label="Удалить студента ${escapeHtml(student.fullName)}">Удалить</button>
        </div>
      </td>
      `;
